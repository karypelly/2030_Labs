...
public class Matrix {
	...
	public void rotateClockwise() {
		/* Your Task */
		Matrix m = new Matrix(this.getNumberOfColumns(), this.getNumberOfRows());
		for (int i = 0; i < imp.length; i++) {
			m.setColumn(m.getNumberOfColumns()-i-1, getRow(i));
		}
		this.imp = m.imp; 
	}
	...
	public void shiftLeft() {
		/* Your Task */
		Matrix m = new Matrix(this.getNumberOfRows(), this.getNumberOfColumns());
		for (int i = 0; i < imp[0].length-1; i ++) {
			m.setColumn(i, getColumn(i+1));
		}
		m.setColumn(m.getNumberOfColumns()-1, this.getColumn(0));
		this.imp = m.imp; 
	}
	...
	public void shiftUp() {
		...
		for (int i = 0; i < imp.length-1; i ++) {
			m.setRow(i, getRow(i+1));
		}
		m.setRow(m.getNumberOfRows()-1, this.getRow(0));
		this.imp = m.imp; 
	}
}
